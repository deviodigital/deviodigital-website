;(function () {
	...
	var portfolioWayPoint = function() {
		...
		if ( $('#fh5co-portfolio').length > 0 ) {
			$('#fh5co-portfolio').waypoint( function( direction ) {
				...
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					...
					setTimeout(function(){
						$('.animate-portfolio-1').addClass('animated fadeIn');
					}, 100);
					setTimeout(function(){
						$('.animate-portfolio-2').addClass('animated fadeIn');
					}, 200);
					setTimeout(portfolioAnimate, 500);
					setTimeout(function(){
						$('.animate-portfolio-3').addClass('animated fadeInUp');
					}, 1400);
	...
	var blogWayPoint = function() {
		...
		if ( $('#fh5co-blog').length > 0 ) {
			$('#fh5co-blog').waypoint( function( direction ) {
					...
					setTimeout(function(){
						$('.animate-blog-1').addClass('animated fadeIn');
					}, 200);
					setTimeout(function(){
						$('.animate-blog-2').addClass('animated fadeIn');
					}, 300);
					setTimeout(blogAnimate, 700);
